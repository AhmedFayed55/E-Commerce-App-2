...
class ProductResponseDto extends ProductsResponseEntity {
  ProductResponseDto({
    super.results,
    super.metadata,
    super.data,
  ...
  ProductResponseDto.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
        data?.add(ProductsDataDto.fromJson(v));
      });
    }
  }
}

class ProductsDataDto extends ProductsDataEntity {
  ProductsDataDto({
    super.sold,
    super.images,
    super.subcategory,
  ...
  ProductsDataDto.fromJson(dynamic json) {
    sold = json['sold'];
    ...
    category =
        json['category'] != null
            ? ProductCategoryDto.fromJson(json['category'])
            : null;
    brand =
        json['brand'] != null ? ProductBrandDto.fromJson(json['brand']) : null;
...
class ProductBrandDto extends ProductBrandEntity {
  ProductBrandDto({super.id, super.name, super.slug, super.image});
...
class ProductCategoryDto extends ProductCategoryEntity {
  ProductCategoryDto({super.id, super.name, super.slug, super.image});
...
class ProductSubcategoryDto extends ProductSubcategoryEntity {
  ProductSubcategoryDto({super.id, super.name, super.slug, super.category});
