class ProductsResponseEntity {
  ProductsResponseEntity({this.results, this.metadata, this.data});
...
class ProductBrandEntity {
  ProductBrandEntity({this.id, this.name, this.slug, this.image});
...
class ProductCategoryEntity {
  ProductCategoryEntity({this.id, this.name, this.slug, this.image});
...
class ProductSubcategoryEntity {
  ProductSubcategoryEntity({this.id, this.name, this.slug, this.category});
